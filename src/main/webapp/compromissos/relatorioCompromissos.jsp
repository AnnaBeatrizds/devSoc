                    ...
                    <s:form action="gerarRelatorioHTML" method="post" theme="simple">
                        <div class="row align-items-center mb-3">
                            ...
                            <div class="col-md-2 d-flex align-items-end">
                                <s:submit value="%{getText('label.gerarRelatorio')}" cssClass="btn btn-primary"/>
                            </div>
                            <div class="col-md-2 d-flex align-items-end">
                                <a href="#" class="btn btn-success" onclick="exportarExcel()"><s:text name="label.exportarExcel"/></a>
                            </div>
                        </div>
                    </s:form>
                </div>
