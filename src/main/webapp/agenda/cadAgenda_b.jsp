...
<div class="container">
    ...
    <div class="row mt-5 mb-2">
        <div class="col-sm p-0">
            <s:form action="filtrarAgendas">
                <div class="input-group">
                    ...
                    <!-- Combo de opções para buscar por código ou nome -->
                    <s:select  
                    ...
                    <!-- Campo de texto para digitar valor da busca -->
        ...
        <!-- Botão voltar aparece somente se houver valor na busca -->
...
<!-- =================== Script de exclusão e validação =================== -->
<script type="text/javascript">
    // Configura a ação do botão "Sim" do modal
    ...
    // Validação simples do filtro de busca
