...
<html lang="pt-BR">
<head>
    <!-- Configuração da página e Bootstrap -->
    <meta charset="UTF-8">
...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
    ...
    <!-- Menu lateral com links para as ações do Struts -->
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card text-white bg-primary mb-3">
                <div class="card-header">Funcionários Ativos</div>
                <div class="card-body">
                    <h5 class="card-title">152</h5>
                    <p class="card-text">Total de colaboradores cadastrados.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-success mb-3">
                <div class="card-header">Compromissos Hoje</div>
                <div class="card-body">
                    <h5 class="card-title">12</h5>
                    <p class="card-text">Exames e consultas agendadas.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card text-white bg-warning mb-3">
                <div class="card-header">Exames Periódicos a Vencer</div>
                <div class="card-body">
                    <h5 class="card-title">8</h5>
                    <p class="card-text">Nos próximos 30 dias.</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: 'Nº de Exames',
                data: [65, 59, 80, 81, 56, 55], // Dados de exemplo
